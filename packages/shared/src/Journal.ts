...
export class JournalApprovalRequested extends Schema.TaggedClass<JournalApprovalRequested>()(
  "approval-requested",
  {
    turn: NonNegativeInt,
    hop: NonNegativeInt,
    // approvalId is generated by Effect AI's IdGenerator; toolCallId is the
    // id of the tool-call this approval gates (same id as the JournalToolCall
    // part in this (turn, hop) — consumers correlate for display).
